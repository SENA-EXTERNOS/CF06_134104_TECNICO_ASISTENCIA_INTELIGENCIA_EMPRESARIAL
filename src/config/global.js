export default {
  ...
  complementario: [
    {
      ...
      referencia:
        'Portilla, J. (2017). Gobierno de datos, un potenciador de los sistemas de gestión de calidad. Ministerio de Hacienda y Crédito Público, Colombia. Revista Signos, 9(2). p.159-172. ',
      tipo: 'Artículo',
    ...
    },
    {
      tema: 'La analítica y resguardo de los datos en la empresa',
      referencia:
        'Guío, A. (2021). Modelo de gobernanza de la infraestructura de datos para el desarrollo de tecnologías emergentes.',
      tipo: 'PDF',
      descarga:
    ...
    },
    {
      ...
      referencia:
        'García-Jiménez, A.,  Aguilar-Morales,  N., Hernández-Triano,  L. /  Lancaster-Díaz, E. (2021). La inteligencia de negocios: herramienta clave para el uso de la información y la toma de decisiones empresariales. Revista de Investigaciones Universidad del Quindío, 33(1). p.132-139.',
      tipo: 'Artículo',
    ...
    },
    {
      tema:
        'Análisis exploratorio de datos y alistamiento de los sets de datos',
      referencia:
        'IBM Cloud Education. (2020). Análisis exploratorio de datos. IBM Cloud Education. ',
      tipo: 'Página web',
    ...
    },
    {
      tema:
        'Análisis exploratorio de datos y alistamiento de los sets de datos',
      referencia:
        'Consorcio POT Huila. (2019). Informe etapa de Alistamiento. Contrato de consultoría no. 1029 de 2019. “Elaborar el plan de ordenamiento territorial del Departamento del Huila”. ',
      tipo: 'PDF',
    ...
    },
    {
      ...
      referencia:
        'Departamento de Computación, UNAN-Managua. (2014). Bases de datos multidimensionales. UNAN-Managua: Departamento de Computación (video). YouTube.',
      tipo: 'Video',
  ...
  glosario: [
    ...
    },
    {
      ...
      significado:
        'reservorios de datos estandarizados o dinámicos, de fuentes externas o internas a la empresa y que son manejadas, en su mayoría, por herramientas de gestión de datos, es decir, softwares especializados.',
    },
    {
  ...
  referencias: [
    {
      referencia:
        'Consorcio POT Huila. (2019). Informe etapa de Alistamiento. Contrato de consultoría no. 1029 de 2019 “Elaborar el plan de ordenamiento territorial del Departamento del Huila”.',
      link:
        'https://www.sirhuila.gov.co/wp-content/uploads/2022-ACTUALIZACIONES/POD/Alistamiento/Informe-Etapa-Alistamiento.pdf',
    },

    {
      referencia:
        'Departamento Administrativo de la Gestión Pública. (2020). Documento técnico de captura y procesamiento de datos de la Medición del Desempeño Institucional Proceso de Generación de Productos y Servicios para la Gestión Pública.',
      link:
    ...
    {
      referencia:
        'Galarza, C. (2018). Diseño e implementación de una red de datos segura para la Pontificia Universidad Católica del Ecuador, Santo Domingo. Revista Científica Dominio de las Ciencias, 4(2). p.123-137.',
      link:
    ...
    {
      referencia:
        'Kingatúa, A. (2020). Las 10 mejores herramientas de gestión de datos para empresas medianas y grandes. Geekaflare.',
      link: 'https://geekflare.com/es/data-management-software/',
    },

    {
      referencia:
        'Rodríguez J. (2017). Los principales softwares de investigación cualitativa. Fundación para la Investigación Social Avanzada.',
      link:
        'https://isdfundacion.org/2017/09/25/software-de-investigacion-social-y-de-mercados-investigacion-cualitativa/',
    },

    {
      referencia:
        'Rodríguez J. (2017). Los principales softwares de investigación cuantitativa. Fundación para la Investigación Social Avanzada.',
      link:
        'https://isdfundacion.org/2017/10/10/software-de-investigacion-social-y-de-mercados-investigacion-cuantitativa/',
    },

    {
      referencia: 'Solved Magazine. (2020). The history of cloud computing.',
      link:
